...
const Navigation = () => (
  ...
  {['Research', 'CV', 'Mentoring'].map((item) => (
    <NavLink 
      key={item} 
      to={`/${item.toLowerCase()}`} // Keep the leading slash
...
const Home = () => (
  <motion.section className="text-center pt-24 pb-16">
      ...
      <img src="/portfolio/images/me.jpg" alt="Malu Sudha" className="w-32 h-32 mx-auto rounded-full border-4 border-indigo-200 object-cover shadow-md" />
